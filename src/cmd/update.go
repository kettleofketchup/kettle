...
const (
	githubReleasesURL    = "https://github.com/kettleofketchup/kettle/releases/latest/download/kettle"
	githubAPIReleasesURL = "https://api.github.com/repos/kettleofketchup/kettle/releases/latest"
)
